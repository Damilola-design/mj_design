...
<head>
    ...
    <link rel="stylesheet" href="./asset/dropshipping-form/assets/css/style.css?v=1">
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
        ...
        <link rel="stylesheet" href="asset/dropshipping-form/assets/css/extra-style.css">
    ...
    <link rel="stylesheet" href="./asset/dropshipping-form/assets/css/pages-fix.css">

    <link rel="stylesheet" href="./asset/dropshipping-form/assets/css/style2.css">
    <link rel="stylesheet" href="./asset/dropshipping-form/assets/css/page2.css">
    <link rel="stylesheet" href="./asset/dropshipping-form/assets/css/page3.css">
    <link rel="stylesheet" href="./asset/dropshipping-form/assets/css/page54.css">
...
<body>
    <main class="container-fluid extra__container__fluid">
        <div class="wrapper">
            ...
            <nav>
                <div class="logo">
                    <img src="./asset/dropshipping-form/assets/images/diamond.webp" alt="logo">
                    <div class="logo-info">
                        <p>MJ DEVIGN</p>
                        ...
                        <div class="logo-image_1">
                            <div class="row">
                                <div class="col-md-2 pr-0">
                                    <img src="./asset/dropshipping-form/assets/icons/shipping (2).png" alt="drop"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 pl-0">
                                            <h3 class="text-h4" style="font-size: 28px !important;">
                                                <b>Dropshipping Store Package</b>
                                            </h3>
                                        </div>
                                        <div class="col-md-12 text-right" style="font-size: 120%;">Welcome, Name!</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="stepsMain">
                        <div class="stepActive active">
                            <div class="activeTop">
                                ...
                                <div class="activeImg first_img">
                                    <img src="./asset/dropshipping-form/assets/icons/step1.png" alt="step1">
                                </div>
                            ...
                            <div class="activeBody bodyContainer px-4" id="">
                                <div class="inputArea">
                                    ...
                                    <div class="w-100 d-none" id="reg_new">
                                        <div class="iBtn">
                                            <div
                                                style="width: 100%; margin-right: 2%; margin-left: 25px !important; margin-top: 20px;text-align: left !important;">
                                                <label>Enter a domain name for your store</label>
                                                <input type="text" placeholder="wwww.">
                                            </div>
                                        </div>
                                        <p class="my_sitecom" style="margin-right: 2%;margin-left: 25px !important; font-size: 15px">
                                            ...
                                            <div class="px-3">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Enter your existing domain
                                                        name:</label>
                                                    <input type="email" class="common-input py-4 form-control"
                            ...
                            <div class="nextBtn">
                                <a style="margin-right: 5px;" href="./asset/dropshipping-form/page1.html" class="prev_action">
                                    <button class="btn2">
                                        BACK
                                    </button>
                                </a>
                                <a href="./asset/dropshipping-form/page2.html" class="next_action">
                                    <button class="button">
                                        Next
                                    </button>
                                </a>
                        ...
                        <div class="stepActive step-active">
                            <div class="activeTop">
                                <h6 class="sBold">2.</h6>
                                <div class="activeImg">
                                    <img src="./asset/dropshipping-form/assets/icons/step2Head.png" alt="step1">
                                </div>
                                <div class="activeDesc">
                                    <p class="sBold">
                                        STEP 2
                            ...
                            <div class="bodyContainer">
                                                    ...
                                                    <div class="step-category__nav-wrapper">
                                                        ...
                                                        <ul class="step-category__nav">
                                                            <li class="step-category__nav-item step-category__nav-item--active"
                                                                data-category="1">
                                                                <img src="./asset/dropshipping-form/assets/icons/w1.png" alt="">
                                                                <a>
                                                                    Woman’s Fashion
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="2">
                                                                <img src="./asset/dropshipping-form/assets/icons/mc.png" alt="">
                                                                <a>
                                                                    Men’s Fashion
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="3">
                                                                <img src="./asset/dropshipping-form/assets/icons/phoneC.png" alt="">
                                                                <a>
                                                                    Phones & Telecommunication
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="4">
                                                                <img src="./asset/dropshipping-form/assets/icons/comp.png" alt="">
                                                                <a>
                                                                    Computer, Office & Security
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="5">
                                                                <img src="./asset/dropshipping-form/assets/icons/ring.png" alt="">
                                                                <a>
                                                                    Jewellery & Watches
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="6">
                                                                <img src="./asset/dropshipping-form/assets/icons/home.png" alt="">
                                                                <a>
                                                                    Home, Pet & Appliances
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="7">
                                                                <img src="./asset/dropshipping-form/assets/icons/bag.png" alt="">
                                                                <a>
                                                                    Bags & Shoes
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="8">
                                                                <img src="./asset/dropshipping-form/assets/icons/toy.png" alt="">
                                                                <a>
                                                                    Toys, Kids & Babies
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="9">
                                                                <img src="./asset/dropshipping-form/assets/icons/outdoor.png" alt="">
                                                                <a>
                                                                    Outdoor Fun & Sports
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="10">
                                                                <img src="./asset/dropshipping-form/assets/icons/beauty.png" alt="">
                                                                <a>
                                                                    Beauty, Health & Hair
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="11">
                                                                <img src="./asset/dropshipping-form/assets/icons/auto.png" alt="">
                                                                <a>
                                                                    Automobiles & Motorcycles
                                                                </a>
                                                            </li>
                                                            <li class="step-category__nav-item" data-category="12">
                                                                <img src="./asset/dropshipping-form/assets/icons/tool.png" alt="">
                                                                <a>
                                                        ...
                                                        <div class="step-category-item">
                                                            ...
                                                            <label class="step-category-item__label toggle">
                                                                <input class="step-category-item__label-input toggle__input"
                                                                       type="checkbox" id="Blouses & Skirts">
                                ...
                                <div class="nextBtn">
                                    ...
                                    <a href="./asset/dropshipping-form/page3.html" class="next_action">
                                        <button class="button">
                                            Next
                                        </button>
                                    </a>
                        ...
                        <div class="stepActive">
                            <div class="activeTop">
                                <h6 class="sBold">3.</h6>
                                <div class="activeImg">
                                    <img src="./asset/dropshipping-form/assets/icons/step3Head.png" alt="step1">
                                </div>
                                <div class="activeDesc">
                                    <p class="sBold">
                                        STEP 3
                            ...
                            <div class="bodyContainer">
                                <div class="activeBody stores">
                                    ...
                                    <form action="" class="form">
                                        ...
                                        <!-- <div class="upload"> -->
                                        <!-- <img src="./assets/icons/drag.png" alt=""> -->
                                        <!-- <p class="lg_light"> -->
                                ...
                                <p class="divider"></p>
                                <div class="nextBtn">
                                    <a style="margin-right: 5px;" href="./asset/dropshipping-form/page2.html" class="prev_action">
                                        <button class="btn2">
                                            BACK
                                        </button>
                                    </a>
                                    <a href="./asset/dropshipping-form/page4.html" class="next_action">
                                        <button class="button">
                                            Next
                                        </button>
                                    </a>
                        ...
                        <div class="stepActive">
                            <div class="activeTop">
                                <h6 class="sBold">4.</h6>
                                <div class="activeImg">
                                    <img src="./asset/dropshipping-form/assets/icons/step5Head.png" alt="step1">
                                </div>
                                <div class="activeDesc">
                                    <p class="sBold">
                                        STEP 4
                            ...
                            <div class="bodyContainer">
                                <div class="activeBody stores">
                                    ...
                                    <div class="optionalContent">
                                        <div class="optionalRow">
                                            <div class="left">
                                                <img src="./asset/dropshipping-form/assets/icons/option1.png" alt="">
                                                <p>
                                                    Custom Email<br>Address
                                                </p>
                                            </div>
                                            <div class="right">
                                                <p class="bold">
                                                ...
                                                <div class="checkBox d-flex">
                                                    ...
                                                    <label for="price">
                                                        $150.00 - Add To Package
                                                    </label>
                                                </div>
                                                <p class="details">
                                                    A personalised email address with 1 year hosting & a professional
                                                    template design to match your store. We also help you connect it to all
                                                    of your devices. <a href="javascript:void(0)">
                                                    Learn more
                                                </a>
                                                </p>
                                            </div>
                                        ...
                                        <div class="optionalRow">
                                            <div class="left">
                                                <img src="./asset/dropshipping-form/assets/icons/option2.png" alt="">
                                                <p>
                                                    Customer<br>Account
                                                </p>
                                            </div>
                                            <div class="right">
                                                ...
                                                <div class="checkBox d-flex">
                                                    ...
                                                    <label for="100">
                                                        $100.00 - Add To Package
                                                    </label>
                                                </div>
                                                <p class="details">
                                                    Enable your customers to create an account on your store to view and
                                                    track their orders. Alternatively, this information will be sent to them
                                                    by email.<a href="javascript:void(0)">
                                                    Learn more
                                                </a>
                                                </p>
                                            </div>
                                        ...
                                        <div class="optionalRow">
                                            <div class="left">
                                                <img src="./asset/dropshipping-form/assets/icons/option3.png" alt="">
                                                <p>
                                            ...
                                            <div class="right">
                                                ...
                                                <p class="details">
                                                    We will set up a marketing campaign for Google & Facebook ads, targeting
                                                    your audiences with a $100 voucher to get started.<a
                                        ...
                                        <div class="optionalRow">
                                            <div class="left">
                                                <img src="./asset/dropshipping-form/assets/icons/option4.png" alt="">
                                                <p>
                                                    Social Media<br>Package
                                                </p>
                                            </div>
                                            <div class="right">
                                                <p class="bold">
                                                ...
                                                <div class="checkBox d-flex">
                                                    ...
                                                    <label for="130">
                                                        $130.00 - Add To Package
                                                    </label>
                                                </div>
                                                <p class="details">
                                                    We will set your store up with a Facebook, Instagram and Twitter account
                                                    and design appealing banners and content<a href="javascript:void(0)">
                                                    Learn more
                                                </a>
                                                </p>
                                            </div>
                                        ...
                                        <div class="optionalRow">
                                            <div class="left">
                                                <img src="./asset/dropshipping-form/assets/icons/option5.png" alt="">
                                                <p>
                                                    Multilingual &<br>Multiple Currencies
                                                </p>
                                            </div>
                                            <div class="right">
                                                <p class="bold">
                                                ...
                                                <div class="checkBox d-flex">
                                                    ...
                                                    <label for="199">
                                                        $199.00 - Add To Package
                                                    </label>
                                                </div>
                                                <p class="details">
                                                    A plugin where customers can switch between currencies and automatically
                                                    displays their native currency based on geolocation<a
                                                        href="javascript:void(0)">
                                                    Learn more
                                                </a>
                                                </p>
                                        ...
                                        <div class="optionalRow">
                                            <div class="left">
                                                <img src="./asset/dropshipping-form/assets/icons/option6.png" alt="">
                                                <p>
                                                    Title & Description<br>Editing
                                                </p>
                                            </div>
                                            <div class="right">
                                                <p class="bold">
                                                    Product Title & Description Editing
                                                </p>
                                                <div class="checkBox d-flex">
                                                    <input type="checkbox">
                                                    <select>
                                                ...
                                                <p class="details">
                                                    Product information written by suppliers can often be lengthy. We will
                                                    edit content about your products with appealing & relevant
                                                    information.<a href="javascript:void(0)">
                                                    Learn more
                                                </a>
                                                </p>
                                            </div>
                                        ...
                                        <div class="optionalRow">
                                            <div class="left">
                                                <img src="./asset/dropshipping-form/assets/icons/option7.png" alt="">
                                                <p>
                                            ...
                                            <div class="right">
                                                ...
                                                <p class="details">
                                                    A minute long appealing promotional video that can be integrated into your website and social media to help boost sales.<a href="javascript:void(0)">
                                                    Learn more
                                                </a>
                                                </p>
                                            </div>
                                ...
                                <div class="nextBtn">
                                    <a style="margin-right: 5px;" href="./asset/dropshipping-form/page3.html" class="prev_action">
                                        <button class="btn2">
                                            BACK
                                        </button>
                                    </a>
                                    <a href="./asset/dropshipping-form/page6.html" class="next_action">
                                        <button class="button">
                                            Next
                                        </button>
                                    </a>
                        ...
                        <div class="stepActive orderStep">
                            <div class="activeTop">
                                <h6 class="sBold">5.</h6>
                                <div class="activeImg">
                                    <img src="./asset/dropshipping-form/assets/icons/step6.png" alt="step1">
                                </div>
                                <div class="activeDesc">
                                    <p class="sBold">
                                        STEP 5
                            ...
                            <div class="activeBody bodyContainer stores">
                                ...
                                <div class="outer-box">
                                    <div class="checkout-image">
                                        ...
                                        <img src="./asset/dropshipping-form/assets/icons/credit-card.jpg" alt="step1">
                                    </div>
                                    <div class="checkout-image">
                                        <label class="_2_LU_"><input type="radio" class="Qg8Oo" checked="" value="Afterpay" name="comp-kjjsylbi1">Afterpay</label>
                                        <img src="./asset/dropshipping-form/assets/icons/afterpay.jpg" alt="step1">
                                    </div>
                                ...
                                <div class="nextBtn hasPadding">
                                    ...
                                    <a href="./asset/dropshipping-form/thnaks.html" class="btn_checkout">
                                        <button class="button">
                                            Checkout
                                        </button>
                                    </a>
                        ...
                        <div class="orderContainer">
                            ...
                            <div class="orderBody">
                                ...
                                <div class="s_betweens">
                                    <div>
                                        <p>
                                            <img src="./asset/dropshipping-form/assets/icons/coupn.png" alt="step1" class="enter"> Enter a promo
                                            code
                                        </p>
                                    </div>
    ...
    <div class="background-image">
        <img src="./asset/dropshipping-form/assets/images/banner2.png" />
    </div>
    <script src="./asset/dropshipping-form/assets/js/main.js"></script>
</body>
